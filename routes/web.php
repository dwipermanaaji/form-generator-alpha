...
Route::get('/', function () {
    return redirect('/form-generator');
});

route::get('/form-generator',[FormGeneratorController::class, 'index'])->name('form-generator.index');
route::get('/form-generator/build',[FormGeneratorController::class, 'build'])->name('form-generator.build');
